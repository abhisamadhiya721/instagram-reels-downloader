...
function App() {
  ...
  return (
    ...
    <div className="container bg-gray-100">
      ...
      <a href='https://www.instagram.com/digicryptmedia?igsh=MXI0bTBqbzl2MDI1OQ==' target='digicryptmedia' rel='noreferrer' className='flex gap-2 flex-row justify-center items-center'>
        ...
        <h1 className='text-xl text-black font-semibold font-mono'>Made by DigiCrypt Media</h1>
      </a>
